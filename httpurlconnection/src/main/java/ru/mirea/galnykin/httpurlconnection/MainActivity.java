package ru.mirea.galnykin.httpurlconnection;
...
import ru.mirea.galnykin.httpurlconnection.databinding.ActivityMainBinding;
        ...
        protected void onPostExecute(String result) {
            try {
                ...
                if (responseJson.has("current_weather")) {
                    ...
                    binding.weatherText.setText(String.format("Temperature: %s\nWindspeed: %s", temperature, windspeed));
                } else {
                    ...
                    if (keys != null) {
                        ...
                        SimpleAdapter adapter = new SimpleAdapter(MainActivity.this, arrayList, android.R.layout.simple_list_item_2,
